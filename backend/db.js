...
function seedIfEmpty() {
  ...
  if (blogCount === 0) {
    ...
    const rows = [
      ['Тренды барберинга 2026: что будет популярно в этом году', 'Разбираем главные тренды мужских стрижек и уходовых процедур, которые будут доминировать в 2026 году. Что заказывают клиенты, какие техники в моде.', 'Тренды', '/images/img-1770253980751-ba1ebc8fdf48.jpg', '5 мин', 1, '2026-02-20 10:00:00'],
      ['История нашей школы: как маленький класс стал школой №1 в Воронеже', 'Рассказываем путь BARBER HOUSE: от первых 6 студентов в небольшом помещении до 500+ выпускников и собственного учебного барбершопа.', 'О школе', '/images/img-1543697506-6729425f7265.jpg', '7 мин', 0, '2026-02-15 10:00:00'],
      ['Итоги конкурса "Золотой Шейвер 2025"', 'В декабре 2025 прошёл наш ежегодный конкурс барберов среди выпускников школы. Рассказываем о победителях и лучших работах.', 'События', '/images/img-1638636241638-aef5120c5153.jpg', '4 мин', 0, '2026-01-05 10:00:00'],
      ['Как выбрать профессиональный инструмент барбера: полный гид', 'Машинки, триммеры, бритвы, ножницы — что купить на старте карьеры и на что не стоит тратить деньги. Рекомендации наших преподавателей.', 'Советы', '/images/img-1758812818698-6ecd792a87da.jpg', '8 мин', 0, '2026-01-28 10:00:00'],
      ['Выпускник Сергей: "Бросил IT в 35 лет — и ни о чём не жалею"', 'История одного из наших самых вдохновляющих выпускников. Программист с 10-летним стажем ушёл в барберинг и стал наставником в BARBER HOUSE.', 'Истории', '/images/img-1592304346250-ef7244f8c9cc.jpg', '6 мин', 0, '2026-02-10 10:00:00'],
      ['Весенние акции в школе: скидки и специальные предложения', 'К 8 марта и весеннему сезону мы подготовили специальные предложения для новых студентов. Рассрочка 0%, бонусный инструментарий и другие приятности.', 'Акции', '/images/img-1593185196543-01541d9258e0.jpg', '3 мин', 1, '2026-03-01 10:00:00'],
    ];
    const tx = db.transaction(() => { for (const r of rows) ins.run(...r); });
    tx();
  }
